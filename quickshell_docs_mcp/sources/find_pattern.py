...
_PATTERNS: list[dict] = [
    ...
    },
    {
        ...
        "api_hints": ["NotificationServer", "Notification"],
    },
    {
        "key": "osd",
    ...
    },
    {
        ...
        "api_hints": ["Process", "IpcHandler"],
    },
    {"key": "lock", "aliases": [], "api_hints": ["WlSessionLock"]},
    {
        "key": "workspaces",
        "aliases": ["workspace indicator", "workspace switcher"],
        "api_hints": ["HyprlandWorkspace", "HyprlandMonitor", "I3Workspace"],
    },
    {"key": "tray", "aliases": [], "api_hints": ["SystemTray", "SystemTrayItem"]},
    {"key": "ipc", "aliases": [], "api_hints": ["IpcHandler", "FileView"]},
    {"key": "services", "aliases": [], "api_hints": ["Process", "FileView"]},
    ...
    {"key": "network", "aliases": [], "api_hints": ["WifiDevice", "Network"]},
